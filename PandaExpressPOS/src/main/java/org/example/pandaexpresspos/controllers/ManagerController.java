...
//        // Create the layout to add to dialog
        VBox inputsContainer = new VBox();
        Label startingMonthLabel = new Label("Start Month: ");
        TextField startingMonth = new TextField();
        Label endingMonthLabel = new Label("End Month: ");
        TextField endingMonth = new TextField();
        Label startingWeekLabel = new Label("Start Week :");
        TextField startingWeek = new TextField();
        Label endingWeekLabel = new Label("End Week :");
        TextField endingWeek = new TextField();
        Label startingDayLabel = new Label("Start Day :");
        TextField startingDay = new TextField();
        Label endingDayLabel = new Label("End Day :");
        TextField endingDay = new TextField();
        Label startingHourLabel = new Label("Start Hour :");
        TextField startingHour = new TextField();
        Label endingHourLabel = new Label("End Hour :");
        TextField endingHour = new TextField();
        Label ItemNameLabel = new Label("Item Name :");
        TextField ItemName = new TextField();
        dialog.setTitle(" Sales by Item");
